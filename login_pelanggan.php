...
if(isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM pelanggan WHERE nama = '$nama' AND password = '$password'";
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        echo "<script>alert('Username atau password salah. Silakan coba lagi.'); window.location='login_pelanggan.php';</script>";
        exit();
    }
}
?>
